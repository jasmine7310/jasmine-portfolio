...
export default function Restaurant() {
    return (
        ...
        <img alt="Customer_GUI" src="jasmine7310/projects/Customer_GUI.PNG" class="restaurant-img"/>
        <img alt="Deliverer_GUI" src="jasmine7310/projects/Deliverer_GUI.png" class="restaurant-img"/>
        <h2>Project Report</h2>
        <iframe title="Restaurant Delivery App Report" src="jasmine7310/projects/OOP_Final_Report.pdf" width="100%" height="800"/>
        </>
    )
}