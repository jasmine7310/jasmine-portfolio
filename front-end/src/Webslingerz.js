...
export default function Webslingerz() {
    return (
        ...
        <p>Game developed with team using containers for web app and MongoDB. Copy the repository on Github onto your local machine and follow the instructions to run locally! Happy bird collecting!</p>
