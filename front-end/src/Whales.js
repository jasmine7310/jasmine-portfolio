...
export default function Whales(){
    return(
        <div>
            ...
            <img className="img-mock" alt="KeepItClean_1" src="/projects/KeepItClean_mock.png" />
            <div className="img-align">
                <img alt="KeepItClean_1" src="/projects/KeepItClean_1.png" />
                <img alt="KeepItClean_1" src="/projects/KeepItClean_2.png" />
                <img alt="KeepItClean_1" src="/projects/KeepItClean_3.png" />
            </div>
            <h2>Direction 2</h2>
            ...
            <img className="img-mock" alt="whale_mock" src="/projects/whale_mock.png" />
            <div className="img-align">
                <img alt="whale_1" src="/projects/whale_1.png" />
                <img alt="whale_2" src="/projects/whale_2.png" />
                <img alt="whale_3" src="/projects/whale_3.png" />
            </div>
            <h2>Draft</h2>
            ...
            <img className="img-mock" alt="sea_mock" src="/projects/sea_mock.png" />
            <div className="img-align">
                <img alt="sea_1" src="/projects/sea_1.png" />
                <img alt="sea_2" src="/projects/sea_2.png" />
                <img alt="sea_3" src="/projects/sea_3.png" />
            </div>
        </div>
    )
}